...
Status: **implementation under review in GitHub PR #10**. The runtime,
contract, packaging checks, and documentation are implemented. Keep Issue #8
open until real Python and Node/TypeScript repository dogfood records the
measured result and a human decides whether the global-policy/audit-hook rollout
should begin.
